    ...
    createModal(card, employee){
        ...
        modal.innerHTML = `<div class="modal">
                                ...
                                <div class="modal-info-container">
                                    ...
                                    <p class="modal-text">${employee.address.country}</p>
                                    <hr>
                                    <p class="modal-text"> ${employee.phone}</p>
                                    <p class="modal-text cap">${employee.address.street.number} ${employee.address.street.name} ${employee.address.city}, ${employee.address.state} ${employee.address.postcode}</p>
